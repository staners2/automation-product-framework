...
class ProductsModel(models.Model):
    ...
    base_namespace = models.ForeignKey(NamespacesModel, related_name="base_namespaces", blank=True, null=True, on_delete=models.SET_NULL, help_text="Пространство Jira")
    base_chat_id = models.ForeignKey(ChatsModel, related_name="base_chat_id", blank=True, null=True, on_delete=models.SET_NULL, help_text="Чат для отправки оповещений")
