...
from web.serializers.namespaces.CreateNamespacesSerializer import (
    CreateNamespacesSerializer,
)
from web.serializers.namespaces.GetNamespacesSerializer import GetNamespacesSerializer
from web.serializers.namespaces.UpdateNamespacesSerializer import (
...
class NamespacesViewSets(ModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        if page is not None:
            serializer = GetNamespacesSerializer(page, many=True)
            return self.get_paginated_response(serializer.data)

        serializer = GetNamespacesSerializer(queryset, many=True)
        return Response(serializer.data)

    def retrieve(self, request, *args, **kwargs):
        instance = self.get_object()
        serializer = GetNamespacesSerializer(instance)
        return Response(serializer.data)

    def create(self, request, *args, **kwargs):
        serializer = CreateNamespacesSerializer(data=request.data)
